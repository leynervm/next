...
class MarketplaceController extends Controller
{
    ...
    {
        $desarrollo = [
            'image' =>   asset('images/tic/ds_principal.webp'),
            'content' => [
                [
                    'title' => 'DevOps',
                    ...
                    'url' => asset('images/tic/ds_devops.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/ds_ingenieria.webp'),
                ]
            ]
        ];
        $soporte = [
            'image' =>   asset('images/tic/st_principal.webp'),
            'content' => [
                [
                    'title' => 'Cambio de Pantalla',
                    'description' => 'Devuélvele la claridad a tu dispositivo: cambio de pantalla para que disfrutes cada detalle de nuevo.',
                    'url' => asset('images/tic/st_cambio_pantalla.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/st_repotenciamos_pc.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/st_cambio_teclado.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/st_instalacion_sw.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/st_impresora.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/st_reparacion_case.webp'),
                ],
            ]
        ];
        $seguridad = [
            'image' =>   asset('images/tic/se_principal.webp'),
            'content' => [
                [
                    ...
                    'url' => asset('images/tic/se_camaras.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/se_alarmas.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/se_acceso.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/se_sensores_humo.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/se_vigilancia_nube.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/se_sensores_movimiento.webp'),
                ],
            ]
        ];
        $datacenter = [
            'image' => asset('images/tic/dc_principal.webp'),
            'content' => []
        ];
        $redes = [
            'image' =>   asset('images/tic/rt_principal.webp'),
            'content' => [
                [
                    ...
                    'url' => asset('images/tic/rt_conectividad.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/rt_redes_privadas.webp'),
                ],
                [
                ...
                [
                    ...
                    'url' => asset('images/tic/rt_instalacion.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/rt_seguridad_redes.webp'),
                ],
            ]
        ];
        $electricidad = [
            'image' =>   asset('images/tic/ea_principal.webp'),
            'content' => [
                [
                    ...
                    'url' => asset('images/tic/ea_instalaciones_led.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/ea_control_climatizacion.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/ea_paneles_electricos.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/ea_inspeccion_seguridad.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/ea_deshumidificacion.webp'),
                ],
                [
                    ...
                    'url' => asset('images/tic/ea_asesoramiento_energetico.webp'),
                ]
            ]
        ];

        $data = response()->json([
            'image' => asset('images/home/recursos/tic.webp'),
