<x-app-layout>
    <x-slot name="breadcrumb">
        ...
        @can('admin.facturacion.guias')
            <x-link-breadcrumb text="GUÍAS REMISIÓN" route="admin.facturacion.guias">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
        ...
        <x-link-breadcrumb text="MOTIVOS TRASLADO" active>
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    <path
    ...
    @can('admin.facturacion.guias.motivos.create')
        <div class="flex flex-wrap gap-2 mt-3">
            <livewire:modules.facturacion.motivos.create-motivo-traslado />
        </div>
    @endcan

    @can('admin.facturacion.guias.motivos')
        <div class="w-full mt-3">
            <livewire:modules.facturacion.motivos.show-motivos-traslado />
        </div>
    @endcan
</x-app-layout>
