...
namespace Modules\Almacen\Http\Livewire\Units;
...
class ShowUnits extends Component
{
    ...
    public function render()
    {
        ...
        return view('almacen::livewire.units.show-units', compact('units'));
    }
    ...
    public function confirmDelete(Unit $unit)
    {
        $this->dispatchBrowserEvent('units.confirmDelete', $unit);
    }
