...
class ShowEspecificaciones extends Component
{
    ...
    protected $listeners = ['render', 'delete', 'deleteEspecificacion'];
    ...
    public function render()
    {
        ...
        return view('almacen::livewire.especificaciones.show-especificaciones', compact('caracteristicas'));
    }
    ...
    public function confirmDelete(Caracteristica $caracteristica)
    {
        $this->dispatchBrowserEvent('caracteristica.confirmDelete', $caracteristica);
    }
    ...
    public function confirmDeleteEspecificacion(Especificacion $especificacion)
    {
        $this->dispatchBrowserEvent('especificaciones.confirmDelete', $especificacion);
    }
