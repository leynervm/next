<div>
    <x-minicard :title="'S/.' . number_format($amountdeuda, 3, '.', ', ')" size="md">
        ...
        <p class="text-[10px] font-semibold leading-3 text-center uppercase">
            Saldo pendiente</p>
    </x-minicard>
                        ...
                        <tr>
                            <td class="p-2">
                                <a class="inline-block text-linktable hover:underline hover:text-hoverlinktable"
                                    href="{{ route('admin.ventas.show', $item->id) }}">
                                    {{ $item->code }}
                                    <br>
