...
return [
    ...
    'attributes'           => [
        ...
        'lugar_id'                  =>  'lugar',
        'datos.local_entrega'       =>  'lugar',
        'datos.local_entrega.id'    =>  'lugar',
        'datos.shipmenttype'        =>  'tipo de envío',
        'datos.shipmenttype.id'     =>  'tipo de envío',
        'datos.daterecojo'          =>  'fecha de recojo',
        'datos.g_recaptcha_response' =>  'código recaptcha',
        'datos.terms'               =>  'términos',
        'datos.receiver_info.document'  =>  'documento',
        ...
        'datecodegarantia'         =>  'medida de garantía',
        'timeentrega'               =>  'tiempo de entrega',
        'direccioninstalacion'      =>  'dirección de instalación',
        'ubigeo_id'                 =>  'lugar',
        'validez'                   =>  'fecha de validéz',
        'productofree_id'           =>  'producto',
        'cantidadfree'              =>  'cantidad',
        'nameother'                 =>  'nombre',
        'cantidadother'             => 'cantidad',
        'marcaother'                => 'marca',
        'priceother'                => 'precio',
        'others'                    => 'otros',
