            ...
            <div class="w-full" x-data="loader">
                ...
                @if (getCombo()->count() > 0)
                    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-2">
                        <div class="w-full grid grid-cols-1 xs:grid-cols-2 gap-2">
                            ...
                            <div class="">
                                @if ($agotarstock)
                                    <x-span-text text="HASTA AGOTAR MÁXIMO UNIDADES DISPONIBLES"
                                        class="leading-3 !tracking-normal" />
                                @else
                                    <x-span-text :text="'STOCK MÁXIMO : ' .
                                        getCombo()->get('limit') .
                                        ' ' .
                                        getCombo()->get('unit')" class="leading-3 !tracking-normal font-semibold" />
                                @endif
                            </div>

                            @if ($producto)
                                @if (count($producto->almacens) > 0)
                                    <div class="w-full xs:col-span-2 flex flex-wrap gap-2">
                            ...
                            @if (count(getCombo()->get('comboitems')) > 0)
                                <div class="w-full flex flex-col gap-1">
                                    @foreach (getCombo()->get('comboitems') as $item)
                                        <div
                                            class="w-full shadow shadow-shadowminicard rounded-md hover:shadow-md hover:shadow-shadowminicard p-1 bg-body">
                    ...
                    <form wire:submit.prevent="add" class="w-full mt-6 flex flex-col gap-2">
                        <x-title-next titulo="AGREGAR PRODUCTOS SECUNDARIOS" />
                ...
                @else
                    <form wire:submit.prevent="confirmar">
                        <div class="w-full grid grid-cols-1 xs:grid-cols-2 gap-1">
                            ...
                            <div class="w-full">
                                <div x-show="agotarstock == false">
                                    <x-label value="stock Máximo:" />
                                    <x-input class="block w-full" wire:model.defer="limit" type="number"
                                        min="0" step="1" />
