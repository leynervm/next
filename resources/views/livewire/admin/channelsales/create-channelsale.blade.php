    ...
    <x-jet-dialog-modal wire:model="open" maxWidth="lg" footerAlign="justify-end">
        ...
        <x-slot name="content">
            <form wire:submit.prevent="save">
                ...
                <x-input class="block w-full" wire:model.defer="name" placeholder="Ingrese nombre del canal de venta..." />
                ...
                <div class="mt-3 mb-1">
                    <x-label textSize="[10px]"
                        ...
                        for="default">
                        <x-input wire:model="default" name="default" type="checkbox" id="default" />
