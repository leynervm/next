<div x-data="loadimage()">
    <x-button-next titulo="Registrar" wire:click="$set('open', true)" x-on:click="image=null">
        ...
        <x-slot name="content">
            <form wire:submit.prevent="save">
                <div class="w-full text-center relative">
                    <div class="w-full mx-auto max-w-48 h-48 relative mb-2 shadow-md shadow-shadowminicard rounded-xl overflow-hidden">
                        <template x-if="image">
                    ...
                    <div class="w-full flex flex-wrap items-end justify-center gap-1">
                        ...
                        <x-input-file for="{{ $identificador }}" titulo="SELECCIONAR LOGO"
                            wire:loading.class="disabled:opacity-25" class="">
                            <input type="file" id="{{ $identificador }}" name="photo" x-on:change="loadlogo"
