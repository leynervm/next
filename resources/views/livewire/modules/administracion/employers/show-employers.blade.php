    ...
    <div class="flex items-center gap-2 mt-4">
        <div>
            ...
            <div class="relative flex items-center">
                ...
                <x-input placeholder="Buscar DNI, nombres del personal..." class="block w-full md:w-80 pl-9"
        ...
        <x-slot name="content">
            <form wire:submit.prevent="update" class="relative">
                ...
                <x-form-card titulo="PERFIL USUARIO ACCESO"
                    ...
                    @elseif($employer->user)
                        <x-simple-card class="w-full flex flex-col gap-1 rounded-md cursor-default p-3">
                            <div class="w-full">
                                <h1 class="font-semibold text-sm leading-4 text-primary">
                                    {{ $employer->user->name }}</h1>

                                <h1 class="text-colorlabel font-medium text-xs">
                                    CORREO : {{ $employer->user->email }} </h1>
                            </div>
                            <div class="w-full flex justify-end">
