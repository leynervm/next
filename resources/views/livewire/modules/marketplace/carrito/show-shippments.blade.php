            ...
            @if (count($shipmenttypes) > 0)
                @foreach ($shipmenttypes as $item)
                    <div class="relative w-full xs:max-w-[240px]">
                        ...
                        @if ($item->descripcion)
                            <p class="text-[10px] mt-1 px-3 leading-3 text-left text-colorsubtitleform">
                                {{ $item->descripcion }}
                            </p>
                        @endif
                    </div>
    ...
    <x-simple-card class="w-full rounded-xl mt-5 shadow">
        ...
        <div class="flex flex-col gap-2 p-1 xs:p-3">
            ...
            <div class="w-full">
                ...
                <x-input class="block w-full" x-model="receiver_info.name" placeholder="Nombres del receptor..." />
    ...
    @if (Cart::instance('shopping')->count() > 0)
        <div class="w-full flex flex-col gap-2 mt-4">
            <div class="w-full flex justify-end ">
                <x-button wire:click="save" wire:loading.attr="disabled" class="rounded-xl">
