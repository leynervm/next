        ...
        <x-slot name="content">
            <form wire:submit.prevent="update" class="w-full flex flex-col gap-2">
                ...
                <div class="w-full">
                    ...
                    <x-input class="block w-full" wire:model.defer="shipmenttype.descripcion"
                    ...
                    <x-minicard>
                        @if ($shipmenttype->isEnviodomicilio())
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                ...
                                class="w-12 h-12 block text-colorlabel">
                        ...
                        @else
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 33" fill-rule="evenodd"
                                clip-rule="evenodd" fill="currentColor" class="w-12 h-12 block text-colorlabel">
                                <path
