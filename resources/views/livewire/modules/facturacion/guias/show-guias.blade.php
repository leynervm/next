    ...
    <div class="flex flex-col xs:flex-row xs:flex-wrap gap-2">
        ...
        @if (count($sucursals) > 1)
            <div class="w-full xs:w-full xs:max-w-xs">
                ...
                <div id="parentsearchsucursal" class="relative" x-data="select2Sucursal" wire:ignore>
                    <x-select id="searchsucursal" class="w-full" data-placeholder="null" x-ref="select">
                        <x-slot name="options">
                            @if (count($sucursals))
