<x-jet-action-section>
    ...
    <x-slot name="content">
                ...
                @foreach ($this->sessions as $session)
                    <div class="flex items-center">
                        <div>
                            @if ($session->agent->isDesktop())
                                <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    viewBox="0 0 24 24" stroke="currentColor" class="w-8 h-8 text-colorsubtitleform">
                                    <path
                            ...
                            @else
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2"
                                    ...
                                    class="w-8 h-8 text-colorsubtitleform">
                        ...
                        <div class="ml-3">
                            ...
                            <div>
                                <div class="text-xs text-colorlabel">
                                    {{ $session->ip_address }},
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                <x-button-secondary wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                    {{ __('Log Out Other Browser Sessions') }}
                </x-button-secondary>
            </x-slot>
        </x-jet-dialog-modal>
