...
<div class="w-full relative">
    <div class="w-full fixed bottom-0 right-0 z-[99]" x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
        :class="{
            'bg-next-500': style == 'success',
        ...
        <div class="contenedor mx-auto py-2 px-3 xl:px-0">
            <div class="flex items-center justify-between flex-wrap">
                <div class="w-0 flex-1 flex items-center min-w-0">
                    <span class="flex p-2 rounded-lg"
                        :class="{ 'bg-next-600': style == 'success', 'bg-red-600': style == 'danger' }">
                ...
                <div class="shrink-0 sm:ml-3">
                    <button type="button" class="-mr-1 flex p-2 rounded-md focus:outline-none sm:-mr-2 transition"
                        :class="{
                            'hover:bg-next-600 focus:bg-next-600': style ==
                                'success',
