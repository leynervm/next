...
@section('code')
    <div class="w-full">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -6.86 76.624 76.624" class="block mb-4 mx-auto size-28 xs:size-40">
                ...
                <g id="Group_108" data-name="Group 108">
                    ...
                    <g id="Group_107" data-name="Group 107">
                        <path id="Path_285" data-name="Path 285"
                            ...
                            fill="#ffffff" opacity="0.8" style="mix-blend-mode: screen;isolation: isolate" />
        ...
        <h1
            class="text-3xl !leading-none !xs:leading-normal xs:text-4xl md:text-5xl lg:text-6xl font-bold text-center text-primary mb-4">
            El sitio está en mantenimiento</h1>
        <p class="text-center text-colorsubtitleform text-sm xs:text-lg md:text-xl lg:text-2xl !leading-none mb-8">
            "Estamos implementando mejoras continuas para ofrecerte la mejor experiencia. ¡Pronto tendremos novedades
            para ti!"</p>
...
@section('message')
    <div class="w-full flex flex-col xs:flex-row xs:justify-center flex-wrap gap-1 sm:gap-4">
        <a href="mailto:soporte@next.net.pe"
            class="block w-full xs:w-auto border-2 border-next-500 text-lg text-center sm:text-3xl bg-next-500 hover:bg-next-700 text-white font-medium p-3 sm:p-4 rounded-xl sm:rounded-2xl transition ease-in-out duration-150">
            Contáctanos</a>
        <button type="button" onclick="document.location.reload();"
            class="block w-full xs:w-auto border-2 text-center text-lg sm:text-3xl border-next-500 text-next-500 hover:bg-next-500 hover:text-white font-medium p-3 sm:p-4 rounded-xl sm:rounded-2xl transition ease-in-out duration-150">
            RECARGAR</button>
    </div>
@endsection
