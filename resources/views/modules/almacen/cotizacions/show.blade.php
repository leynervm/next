<x-admin-layout>
    <x-slot name="breadcrumb">
        @if (Module::isEnabled('Almacen') || Module::isEnabled('Ventas'))
            ...
            <x-link-breadcrumb text="DETALLE COTIZACIÓN" active>
                <x-slot name="icon">
    ...
    <div class="mx-auto xl:max-w-7xl h-full pb-20 xs:pb-14">
        <livewire:modules.almacen.cotizacions.show-cotizacion :cotizacion="$cotizacion" />
    </div>
</x-admin-layout>
