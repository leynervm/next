<div
    {{ $attributes->merge(['class' => 'relative p-1 mx-auto flex gap-1 flex-col justify-center items-center border border-borderminicard shadow-md shadow-shadowminicard rounded-lg my-2']) }}>
    @if ($type == 'upload')
