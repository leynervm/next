<div
    {{ $attributes->merge(['class' => 'w-10 h-10 relative p-1 mx-auto flex gap-1 flex-col justify-center items-center border border-borderminicard rounded-xl my-2 text-colorsubtitleform']) }}>
    @if ($type == 'upload')
