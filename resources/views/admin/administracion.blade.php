<x-admin-layout>
    ...
    <div class="flex flex-wrap gap-2 mt-3">
        ...
        @if (Module::isEnabled('Ventas'))
            @canany(['admin.administracion.pricetypes', 'admin.administracion.rangos'])
        ...
        @if (Module::isEnabled('Ventas') || Module::isEnabled('Facturacion'))
            @can('admin.administracion.typepayments')
                <x-link-next href="{{ route('admin.administracion.typepayments') }}" titulo="Tipos de pago">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-full h-full" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path
                        ...
                        <path
                            d="M3 14H5.48624C5.82328 14 6.15484 14.0852 6.45015 14.2476L8.5 15.3751H9.5C11 15.3751 12 16.524 12 17.4998L9.31623 18.3944C9.11096 18.4628 8.88904 18.4628 8.68377 18.3944L6 17.4998M11.9993 17L16.2103 15.5963C17.2149 15.2615 18.3064 15.7677 18.6997 16.7509V16.7509C18.869 17.1743 18.6856 17.6569 18.2777 17.8608L10.6925 21.6534C10.2465 21.8764 9.73337 21.9248 9.25361 21.789L3 20.0199" />
                    </svg>
                </x-link-next>
            @endcan
        @endif
        ...
        @can('admin.administracion.areaswork')
            <x-link-next href="{{ route('admin.administracion.areaswork') }}" titulo="Areas trabajo">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-full h-full" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
